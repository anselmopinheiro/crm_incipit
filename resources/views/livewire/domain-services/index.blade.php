<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('domain-services.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md">Novo domínio</a>
    </div>
                ...
                @forelse($services as $service)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            <a href="{{ route('domain-services.edit', $service) }}" class="text-sm text-gray-700">Editar</a>
